...
//#region node_modules/.nitro/vite/services/ssr/assets/theme-SnWyrOGi.js
var theme_SnWyrOGi_exports = /* @__PURE__ */ __exportAll({
	_: () => AuthError,
	a: () => eventSchema,
...
var ThemeRepository = class extends BaseRepository {
	...
	*/
	async installBlueprintTheme(theme) {
		const { data: existingThemes } = await this.withWorkspace(this.db.from("theme_settings").select("id").limit(1));
