...
import { t as CmsSyncProvider } from "./theme-provider-tKCKqHTY.mjs";
import { t as Route$31 } from "./routes-CJVsSIjt.mjs";
import { randomUUID } from "node:crypto";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BlSy8q67.js
...
function CurrentWorkspaceProvider({ children }) {
	...
	const resolve = (0, import_react.useCallback)(async () => {
		try {
			...
			else if (requestedDomain) ctx = await resolveWorkspaceFromRequest({ workspaceRepository: workspaceRepo }, {
			...
			if (!ctx?.workspaceId) ctx = DEFAULT_WORKSPACE;
...
*/
var $$splitComponentImporter$17 = () => import("./provision-B92CCB-A.mjs");
var Route$29 = createFileRoute("/provision")({ component: lazyRouteComponent($$splitComponentImporter$17, "component") });
var $$splitComponentImporter$16 = () => import("./admin-Du48WEzq.mjs");
...
var $$splitComponentImporter$14 = () => import("./test.result-0RfzZZjd.mjs");
...
var $$splitComponentImporter$13 = () => import("./test.info-DOp3OBUI.mjs");
...
var $$splitComponentImporter$12 = () => import("./test._step-VpsbnhGB.mjs");
