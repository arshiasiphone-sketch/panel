...
//#region node_modules/.nitro/vite/services/ssr/assets/provision-B6XUseWW.js
	...
	const handleSubmit = (0, import_react.useCallback)(async (e) => {
		...
		try {
			...
			if (data.success) {
				...
				setTimeout(() => {
					window.location.href = `/admin?preview_domain=${encodeURIComponent(data.domain ?? `${formData.slug}.nama.app`)}`;
				}, 3e3);
			} else setResult({
				success: false,
