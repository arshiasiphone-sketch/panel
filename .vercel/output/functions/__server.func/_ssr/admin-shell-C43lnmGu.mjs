...
import { E as useSiteContent, T as useRepositories, b as usePageBlocks, c as touchLocalCmsEdit } from "./cms-BzqQuhMP.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-shell-C43lnmGu.js
...
function CommandPalette() {
	...
	function go(to) {
		navigate({
			to,
			search: previewDomain ? { preview_domain: previewDomain } : void 0
		});
		setOpen(false);
	}
	const icons = {
...
function NavList({ isActive, previewSearch, onPick }) {
