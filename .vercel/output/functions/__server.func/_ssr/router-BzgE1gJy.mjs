...
import { d as getLogger, i as DEFAULT_WORKSPACE, r as BaseRepository, t as ACTIVE_WORKSPACE_STATUSES, u as getCache } from "./theme-SnWyrOGi.mjs";
import { a as createRepositories, i as createId, n as WorkspaceRepository, o as createWorkspace, t as PLATFORM_DOMAIN, u as workspacePlanSchema } from "./factory-B4QToRw_.mjs";
import { i as require_react } from "../_libs/dnd-kit__accessibility+react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { r as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { i as fetchThemeSettings, n as QK } from "./cms-kjwVWmsc.mjs";
...
import { t as CmsSyncProvider } from "./theme-provider-CNZZS8z4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BzgE1gJy.js
...
async function resolveWorkspaceByDomain(deps, domainOrSubdomain, isSubdomain = false) {
	return getCache().getOrFetch("workspace_resolver", `domain:${domainOrSubdomain}:${isSubdomain}`, async () => {
...
*/
var _jsxFileName$1 = "C:/Users/Admin/Desktop/final/myproject/src/lib/core/workspace/context.tsx";
...
function CurrentWorkspaceProvider({ children }) {
	...
	const resolve = (0, import_react.useCallback)(async () => {
		try {
			setLoading(true);
			setError(null);
			const { getRepositories, setWorkspaceOnRepositories } = await import("./factory-B4QToRw_.mjs").then((n) => n.s).then((n) => n.n);
			...
			else if (pathResolution.domain) ctx = await resolveWorkspaceFromRequest({ workspaceRepository: workspaceRepo }, {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WorkspaceCtx.Provider, {
		value,
		children
	}, void 0, false, {
...
var _jsxFileName = "C:/Users/Admin/Desktop/final/myproject/src/routes/__root.tsx";
...
function RootComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CurrentWorkspaceProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CmsSyncProvider, { children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Outlet, {}, void 0, false, {
			fileName: _jsxFileName,
			lineNumber: 130,
			columnNumber: 11
...
*/
var $$splitComponentImporter$18 = () => import("./provision-C-feKQN4.mjs");
var Route$29 = createFileRoute("/provision")({ component: lazyRouteComponent($$splitComponentImporter$18, "component") });
var $$splitComponentImporter$17 = () => import("./admin-C0vfLOmU.mjs");
...
var $$splitComponentImporter$16 = () => import("./routes-B8_lf0Ax.mjs");
...
var Route$26 = createFileRoute("/test/")({ beforeLoad: () => {
	throw redirect({ to: "/test/info" });
} });
var $$splitComponentImporter$15 = () => import("./admin.index--0L-x83h.mjs");
var Route$25 = createFileRoute("/admin/")({ component: lazyRouteComponent($$splitComponentImporter$15, "component") });
var $$splitComponentImporter$14 = () => import("./test.result-BU1iH5rV.mjs");
var Route$24 = createFileRoute("/test/result")({
	loader: async ({ context: { queryClient } }) => {
		await queryClient.ensureQueryData({
			queryKey: QK.theme,
			queryFn: fetchThemeSettings
...
var $$splitComponentImporter$13 = () => import("./test.info-DLNMKf20.mjs");
var Route$23 = createFileRoute("/test/info")({
	loader: async ({ context: { queryClient } }) => {
		await queryClient.ensureQueryData({
			queryKey: QK.theme,
			queryFn: fetchThemeSettings
...
var $$splitComponentImporter$12 = () => import("./test._step-DXUJKBjU.mjs");
var Route$22 = createFileRoute("/test/$step")({
	loader: async ({ context: { queryClient } }) => {
		await queryClient.ensureQueryData({
			queryKey: QK.theme,
			queryFn: fetchThemeSettings
...
var $$splitComponentImporter$1 = () => import("./admin.events-m6H4M2Xf.mjs");
...
var $$splitComponentImporter = () => import("./admin.analytics-4RDtD7RN.mjs");
...
var Route$2 = createFileRoute("/api/public/provision")({ server: { handlers: { POST: async ({ request }) => {
	...
	if (existing && existing.status === "failed") {
		txId = existing.id;
		await updateTransaction(txId, { status: "in_progress" });
...
var TestIndexRoute = Route$26.update({
	id: "/test/",
	path: "/test/",
	getParentRoute: () => Route$30
});
...
var TestResultRoute = Route$24.update({
	id: "/test/result",
	path: "/test/result",
	getParentRoute: () => Route$30
});
var TestInfoRoute = Route$23.update({
	id: "/test/info",
	path: "/test/info",
	getParentRoute: () => Route$30
});
var TestStepRoute = Route$22.update({
	id: "/test/$step",
	path: "/test/$step",
	getParentRoute: () => Route$30
});
