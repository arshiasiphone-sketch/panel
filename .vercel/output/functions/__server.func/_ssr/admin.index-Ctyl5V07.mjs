...
import { b as usePageBlocks, d as useAllGalleryImages, f as useAllMenuItems, u as useAllEvents, x as usePageViewStats } from "./cms-BzqQuhMP.mjs";
import { X as ArrowUpRight, p as Sparkles } from "../_libs/lucide-react.mjs";
import { c as Stat, n as Card, o as PageHeader } from "./admin-shell-C43lnmGu.mjs";
import { o as useTestResponses } from "./test-db-T_jnWKyn.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.index-Ctyl5V07.js
...
function Dashboard() {
	...
	const previewDomain = useRouterState({ select: (s) => new URLSearchParams(s.location.search).get("preview_domain") ?? void 0 });
	const previewSearch = previewDomain ? { preview_domain: previewDomain } : void 0;
...
function MiniStat({ label, value, to, previewSearch }) {
...
function QuickLink({ to, label, previewSearch }) {
