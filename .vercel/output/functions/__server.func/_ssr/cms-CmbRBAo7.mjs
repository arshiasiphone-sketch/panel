...
//#region node_modules/.nitro/vite/services/ssr/assets/cms-CmbRBAo7.js
...
*/
function useOptionalWorkspace$1() {
...
function useRepositories() {
	...
	if (ws?.workspace?.workspaceId) setWorkspaceOnRepositories(repos, { workspaceId: ws.workspace.workspaceId });
	return repos;
}
/**
...
function useCreateBlock() {
	const qc = useQueryClient();
	const repos = useRepositories();
	const ws = useOptionalWorkspace$1();
	return useMutation({
