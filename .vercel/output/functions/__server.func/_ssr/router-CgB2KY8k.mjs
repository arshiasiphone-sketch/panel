...
import { a as createId, c as workspacePlanSchema, d as BaseRepository, f as DEFAULT_WORKSPACE, h as getLogger, l as ACTIVE_WORKSPACE_STATUSES, m as getCache, n as PLATFORM_DOMAIN, o as createWorkspace, r as WorkspaceRepository, s as resolveWorkspaceFromRequest } from "./resolver-DUogLIAX.mjs";
...
import { a as setWorkspaceOnRepositories, t as createRepositories } from "./factory-BTTzvRli.mjs";
...
import { i as fetchThemeSettings, n as QK } from "./cms-DGKxqoRl.mjs";
...
import { t as CmsSyncProvider } from "./theme-provider-kbqMZGiV.mjs";
import { t as Route$31 } from "./routes-DTxFoRJr.mjs";
import { randomUUID } from "node:crypto";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CgB2KY8k.js
...
function CurrentWorkspaceProvider({ children }) {
	...
	const resolve = (0, import_react.useCallback)(async () => {
		const { getRepositories, setWorkspaceOnRepositories } = await import("./factory-BTTzvRli.mjs").then((n) => n.n).then((n) => n.n);
...
var Route$30 = createRootRouteWithContext()({
	validateSearch: (search) => ({ preview_domain: typeof search.preview_domain === "string" && search.preview_domain.length > 0 ? search.preview_domain : void 0 }),
	head: () => ({
		meta: [
			{ charSet: "utf-8" },
			{
...
var $$splitComponentImporter$16 = () => import("./admin-DNd24x0P.mjs");
...
var $$splitComponentImporter$15 = () => import("./admin.index-D5Y0G8hH.mjs");
var Route$26 = createFileRoute("/admin/")({ component: lazyRouteComponent($$splitComponentImporter$15, "component") });
var $$splitComponentImporter$14 = () => import("./test.result-TXwpQMiu.mjs");
...
var $$splitComponentImporter$13 = () => import("./test.info-jQlJRu0t.mjs");
...
var $$splitComponentImporter$12 = () => import("./test._step-Co-5j6RB.mjs");
...
async function resolveCallerUserId(request) {
...
var Route$22 = createFileRoute("/api/provision")({ server: { handlers: { POST: async ({ request }) => {
	...
	const ownerUserId = (typeof p.ownerUserId === "string" && p.ownerUserId.length > 0 ? p.ownerUserId : sessionOwnerId) || void 0;
	const input = {
...
var $$splitComponentImporter$1 = () => import("./admin.events-BDOBfWYE.mjs");
...
var $$splitComponentImporter = () => import("./admin.analytics-nn7pyq-w.mjs");
...
var Route$3 = createFileRoute("/api/public/provision-status")({ server: { handlers: { GET: async ({ request }) => {
	...
	const { supabaseAdmin } = await import("./client.server-V7xMqmPH.mjs").then((n) => n.t).then((n) => n.t);
...
var Route$2 = createFileRoute("/api/public/provision")({ server: { handlers: { POST: async ({ request }) => {
	...
	if (!input.ownerUserId || input.ownerUserId.length < 1) return Response.json({
		success: false,
		error: "ownerUserId is required for self-serve provisioning"
	}, { status: 400 });
