...
=======
      className={`inline-flex items-center gap-2 rounded-lg bg-foreground text-background px-3.5 py-2 text-sm font-medium hover:bg-foreground/90 transition disabled:opacity-50 ${p.className ?? ""}`}
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
    >
      {children}
    </button>
...
=======
      className={`inline-flex items-center gap-2 rounded-lg border border-border bg-background px-3.5 py-2 text-sm font-medium hover:bg-muted transition disabled:opacity-50 ${toneClass} ${p.className ?? ""}`}
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
    >
      {children}
    </button>
...
=======
      className={`w-full rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none focus:border-foreground/40 ${p.className ?? ""}`}
    />
  );
}
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
...
=======
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-muted/30 text-foreground font-sans"
...
=======
        <Link to="/admin" className="flex items-center gap-2 shrink-0">
          <div className="h-7 w-7 rounded-lg bg-foreground text-background grid place-items-center text-[11px] font-bold">
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
            ک
          </div>
...
=======
        ...
        >
          ...
          <kbd className="ms-auto text-[10px] rounded border border-border bg-background px-1.5 py-0.5">
            Ctrl K
          </kbd>
        </button>
        <SaveIndicator />
        <button
          onClick={signOut}
          title="خروج"
          className="h-8 w-8 rounded-md grid place-items-center hover:bg-muted text-muted-foreground"
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
        >
...
=======
            className="absolute top-0 right-0 h-full w-72 bg-background border-l border-border p-3 overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <NavList isActive={isActive} onPick={() => setMobileNav(false)} />
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
...
=======
                className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg bg-foreground text-background px-3 py-2 text-xs font-semibold hover:bg-foreground/90"
>>>>>>> acabcc222a0b62f2804abdaf20ce2cd7be8a560a
              >
