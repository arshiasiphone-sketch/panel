...
function SiteContentAdmin() {
  ...
  const hero = {
    ...
    badge: "",
    cta_text: "",
    ...(site?.hero as Partial<Hero> | undefined),
  };
  const contact = {
    address: "",
    phone: "",
    hours: "",
    ...(site?.contact as Partial<Contact> | undefined),
  };
  const social = {
    instagram: "",
    instagram_handle: "",
    ...(site?.social as Partial<Social> | undefined),
  };
    ...
    <div>
      ...
      <Card className="p-4 mb-3">
        ...
        <div className="grid gap-3">
          ...
          <div>
            <Label>عنوان (هر خط در سطر جدید)</Label>
            <Textarea
              rows={3}
              value={hero.title}
          ...
          <div>
            ...
            <Textarea
              rows={3}
              value={hero.subtitle}
              onChange={(e) => update("hero", { ...hero, subtitle: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input
              value={hero.cta_text}
              onChange={(e) => update("hero", { ...hero, cta_text: e.target.value })}
            />
          </div>
        </div>
      </Card>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <div className="sm:col-span-2">
            ...
            <Textarea
              ...
              onChange={(e) => update("contact", { ...contact, address: e.target.value })}
            />
          </div>
          <div>
            <Label>تلفن</Label>
      ...
      <Card className="p-4 mb-3">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <div>
            <Label>اینستاگرام (لینک)</Label>
            <Input
              dir="ltr"
              value={social.instagram}
              onChange={(e) => update("social", { ...social, instagram: e.target.value })}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => update("social", { ...social, instagram_handle: e.target.value })}
            />
          </div>
        </div>
      </Card>
      ...
      <PrimaryButton
        ...
        disabled
      >
        <Save className="h-4 w-4" /> ذخیره خودکار
      </PrimaryButton>
    </div>
  );
}
