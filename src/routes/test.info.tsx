...
function UserInfoPage() {
  ...
  function validate() {
    ...
    if (!phone.trim() || !/^[0-9۰-۹]{10,11}$/.test(phone.replace(/\s/g, "")))
      e.phone = "شماره تماس معتبر وارد کنید";
      ...
      <div className="w-full max-w-sm flex flex-col gap-8 relative z-10">
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            این اطلاعات فقط برای شخصی‌سازی تجربه‌ی تو استفاده میشه.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            {submitting ? "در حال ورود..." : "شروع تست"}
          </motion.button>
        </motion.form>
      </div>
    </TestPageShell>
